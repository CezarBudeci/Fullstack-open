describe('Blog app', function () {
    ...
    describe('When logged in', function () {
        ...
        it('A blog can be created', function () {
            ...
            cy.get('.blog-short').should('contain', 'test title test author');
        });
        ...
        it('A blog can be liked', function () {
            ...
            cy.get('p.message')
                .should('contain', 'A new blog test title by test author added')
                .and('have.css', 'color', 'rgb(0, 128, 0)');
            cy.get('div.blogs').children().should('have.length', 1);
            cy.get('.blog-short').should('contain', 'test title test author');
        ...
        it('A blog can be deleted', function () {
            ...
            cy.get('div.blogs').children().should('to.be', undefined);
        });
        ...
        it('Blogs are sorted by likes', function () {
            ...
            cy.get('div.blogs').children().should('have.length', 2);
